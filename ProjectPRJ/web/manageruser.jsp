                            ...
                            <tbody>
                                <c:forEach var="p" items="${pl}">
                                    <tr>
                                        ...
                                        <td>
                                            ${p.isStatus()==true?"Active":"Inactive"}
                                        </td>
                                        <c:if test="${p.isStatus()==true}">
                                            <td ><a href="DeleteUser?id=${p.getId()}&ss=0" style="display: block;" > <i style="font-size: 29px" class="fa-solid fa-toggle-on"></i></a></td>

                                        </c:if>
                                        <c:if test="${p.isStatus()==false}">
                                            <td ><a href="DeleteUser?id=${p.getId()}&ss=1"  style="display: block;" > <i style="font-size: 29px" class="fa-solid fa-toggle-off"></i></a></td>
                                        </c:if>
                                    </tr>
                                </c:forEach>
                            </tbody>
